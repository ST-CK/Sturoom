  ...
  return (
    <div className="mx-auto w-full max-w-md">
      <form
        ...
        // 카드 내부 패딩을 조금 키우고, 전체는 수직 간격을 space-y로 통일
        ...
        <div className="mt-6 space-y-6">
          ...
          <div className="flex items-center justify-between text-sm text-gray-600">
            ...
            <div className="flex items-center gap-2">
              <Link href="/find-id" className="text-indigo-600 hover:underline">
                아이디 찾기
              </Link>
          ...
          <button
            type="submit"
            className="w-full rounded-xl bg-indigo-600 px-4 py-3 font-semibold text-white shadow-sm hover:bg-indigo-700"
          >
            로그인
          </button>

          {/* OR 구분선: 위/아래 여백을 동일하게(=space-y-6 내에 위치) */}
          ...
          <div className="space-y-3">
            ...
            <button
              type="button"
              className="w-full rounded-xl bg-[#03C75A] px-4 py-3 font-semibold text-white hover:opacity-90"
            >
              네이버로 로그인
            </button>
            <button
