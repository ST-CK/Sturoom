      ...
      <form onSubmit={handleSubmit} className="rounded-2xl border bg-white p-8 shadow-sm">
        ...
        <div className="mt-6 space-y-6">
          ...
          <div className="space-y-2">
            <label htmlFor="userId" className="block text-sm font-medium text-gray-700">아이디(이메일)</label>
            <input
              id="userId" type="email" required
          ...
          <div className="space-y-3">
            ...
            <button
              type="button" onClick={signInWithKakao}
          ...
          <div className="mx-auto mt-8 text-center text-gray-600">
            아직 회원이 아니신가요?
            <div className="mt-3">
              <Link href="/signup" className="inline-flex items-center justify-center rounded-xl bg-indigo-600 px-6 py-3 font-semibold text-white shadow-sm hover:bg-indigo-700">
                회원가입
              </Link>
            </div>
          </div>
